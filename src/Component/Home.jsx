...
import ExpenseTrackerVideo from "../assets/video/ExpenseTracker.mp4"
...
<DeviceFrameset    zoom={active1==false?0.3:0.6}    device="MacBook Pro" color="gold" landscape>
            ...
            {/* <h2 className='font-bold text-4xl py-1 w-[100%] text-center'>Created using MERN Stack</h2> */}
            {/* <img onMouseMove={()=>{}} src={ChatWebImage} className='w-[100%]  h-[100%]'  alt="" /> */}
            <video onMouseEnter={()=>{setactive1(true)}} onMouseLeave={()=>{setactive1(false)}} onmou src={ExpenseTrackerVideo} loop={true}  autoplay={true}  className='w-[100%] h-[100%] content-center ' muted controls={true}></video>
        </DeviceFrameset>
